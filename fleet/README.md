...
|---|---|---|
| RC link | ExpressLRS 2.4 GHz. Transmitter: Radiomaster TX16S MKII MAX (ELRS), HobbyRC #231404, 2023-06-30, £249.98, with a Radiomaster 6200 mAh transmitter battery (£29.99) — the only transmitter purchase in the mail, so taken to be this one. Receivers: Bee35 RadioMaster RP3 V2; 5" Happymodel EP1 Dual TCXO. Modifications, versions and the switch layout: [`radio.md`](radio.md) | Bee35 [`docs/bom.md`](../aircraft/bee35/docs/bom.md), [OQ-02](../aircraft/bee35/docs/open-questions.md); 5" [`docs/bom.md`](../aircraft/fpv-5/docs/bom.md); transmitter invoice read 2026-09-17 |
...
| Firmware | **ArduPilot or iNav fleet-wide; no Betaflight** ([F-DEC-06](decisions.md), 2026-09-25). Bee35: ArduPilot Copter ([DEC-08](../aircraft/bee35/docs/decisions.md), 2026-09-19; it replaced an iNav plan whose commonality premise proved false). 5": Betaflight, version TBC — converts under F-DEC-06. Holybro: none flashed, ArduPilot implied ([DEC-01](../aircraft/holybro-10/docs/decisions.md)). **Reference aircraft, one per firmware** (F-DEC-06 as amended 2026-09-25): the **5" is the reference iNav**, the **Bee35 the reference ArduPilot**, and the **Holybro follows the Bee35**. Only *when* the 5" converts is open ([OQ-01](../aircraft/fpv-5/docs/open-questions.md)) | Bee35 [DEC-08](../aircraft/bee35/docs/decisions.md); 5" [`README.md`](../aircraft/fpv-5/README.md) |
...
| Flow sensor | **Every multirotor carries a downward MicoAir MTF-01P** ([F-DEC-07](decisions.md), 2026-09-25). Bee35 fitted; one each for the 5" and the Holybro 10" **ordered 2026-09-25** (Unmanned Tech #19494, £49.57 the pair inc shipping and tax, due 2026-09-28) | F-DEC-07; order confirmation read 2026-09-25 |
...
the other was **fitted to the ATOMRC Swordfish's canopy**, with its matching camera and antenna,
found 2026-09-17 ([Swordfish `README.md`](../aircraft/swordfish/README.md)); **the Swordfish's
kit moves to the Holybro 10"** (owner, 2026-09-23; Holybro
[DEC-04](../aircraft/holybro-10/docs/decisions.md)), leaving the Swordfish without video. **Which of the two

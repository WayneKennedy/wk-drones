...
| Firmware | **ArduPilot or iNav fleet-wide; no Betaflight** ([F-DEC-06](decisions.md), 2026-09-25). Bee35: ArduPilot Copter ([DEC-08](../aircraft/bee35/docs/decisions.md), 2026-09-19; it replaced an iNav plan whose commonality premise proved false). 5": Betaflight, version TBC — converts under F-DEC-06. Holybro: none flashed, ArduPilot implied ([DEC-01](../aircraft/holybro-10/docs/decisions.md)). When the 5" converts, and to which of the two, is open (5" [OQ-01](../aircraft/fpv-5/docs/open-questions.md)) | Bee35 [DEC-08](../aircraft/bee35/docs/decisions.md); 5" [`README.md`](../aircraft/fpv-5/README.md) |

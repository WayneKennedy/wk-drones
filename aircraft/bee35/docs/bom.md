...
| FC/ESC | MicoAir743 V2 | BMI088 + BMI270 (ArduPilot hwdef and MicoAir's port diagram; earlier listed as BMI088 only), 30.5×30.5, 2–6S, 55 A AM32. Ships with ArduPilot, which it keeps ([DEC-08](decisions.md)) | Unmanned Tech #18595 | £64.99 | 2026-09-07 |
| Flow/ToF | MicoAir MTF-01P | Optical flow + 12 m lidar, MSP mode | Unmanned Tech #18595 | £22.99 | 2026-09-07 |
| GPS/compass | Flywoo GOKU GM10 Mini V3 — **not fitted; the Matek M10Q-5883 flies instead** (owner, 2026-09-22), in a printed mount pitched ~30° nose-up (owner, by eye and phone, 2026-09-22) | u-blox M10050 + QMC5883L, 18×18 mm, 4.1 g. Delivered a few days before 2026-09-19, then **mislaid** (owner, 2026-09-19). A spare Matek M10Q-5883 is in hand, never fitted (owner, 2026-09-19; private wk-inventory `docs/stock.md`) — the original spec before [DEC-05](decisions.md) | Unmanned Tech #18595 | £16.90 | 2026-09-07 |
| RX | RadioMaster RP3 V2 ELRS 2.4 GHz nano | CRSF. Shipped with ExpressLRS 3.3.1 (e051b8), read from its web UI 2026-09-22. Bound to the TX16S the same day by three power cycles, each under ~2 s powered (slower cycling did not enter bind mode) | Unmanned Tech #18595 | £19.99 | 2026-09-07 |
